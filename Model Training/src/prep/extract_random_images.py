...
TARGET_PER_CLASS: Dict[str, int] = {
    "Invasive_Tumor":         10000,
    "DCIS_1":                 10000,
    "DCIS_2":                 10000,
    "Prolif_Invasive_Tumor":  10000,
}

AUG_PIPE: Dict[str, A.BasicTransform] = {
    "Prolif_Invasive_Tumor": A.Compose([
        A.OneOf([
            A.RandomBrightnessContrast(brightness_limit=0.2, contrast_limit=0.2, p=0.8),
            A.HueSaturationValue(hue_shift_limit=10, sat_shift_limit=15, val_shift_limit=10, p=0.8),
            A.RGBShift(r_shift_limit=10, g_shift_limit=10, b_shift_limit=10, p=0.8),
        ], p=1.0),
